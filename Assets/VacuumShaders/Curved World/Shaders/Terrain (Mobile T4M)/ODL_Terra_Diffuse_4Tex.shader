...
Shader "Hidden/VacuumShaders/Curved World/Terrain/Mobile (T4M)/One Directional Light/4Tex"
{
	Properties    
	{                       
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
			   ...
			   "CurvedWorldAvailableOptions"="V_CW_REFLECTIVE;V_CW_VERTEX_COLOR;V_CW_IBL;V_CW_FOG;V_CW_SPECULAR_MOBILE;"  
			 }
		LOD 200		
		Fog{Mode Off} 
