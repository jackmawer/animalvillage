Shader "VacuumShaders/Curved World/Nature/Tree Creator Leaves Fast" 
{
	Properties 
	{
	...
	{ 
		Tags { "IgnoreProjector"="True"
		       ...
		       "CurvedWorldTag"="Nature/Tree Creator Leaves Fast"
	...
	Dependency "OptimizedShader" = "VacuumShaders/Curved World/Nature/Tree Creator Leaves Fast Optimized"
