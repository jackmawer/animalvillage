Shader "VacuumShaders/Curved World/DX11 (Tessellation)/Standard (Edge Length)" 
{
	Properties 
	{
		...
		_V_CW_Tesselation_EdgeLength ("  Edge length", Range(2,50)) = 15	
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque"
			   "CurvedWorldTag"="DX11 (Tessellation)/Standard (Edge Length)" 
		...
		#define V_CW_TESSELATION_EDGE_LENGTH
		#define _NORMALMAP
