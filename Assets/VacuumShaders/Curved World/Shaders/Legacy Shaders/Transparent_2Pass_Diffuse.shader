...
Shader "Hidden/VacuumShaders/Curved World/Legacy Shaders/Transparent (2 Pass)/Diffuse" 
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="Legacy Shaders/Transparent (2 Pass)/Diffuse" 
		...
		CGPROGRAM
		#pragma surface surf BlinnPhong alpha:blend vertex:vert nodirlightmap nodynlightmap
		#pragma target 3.0
