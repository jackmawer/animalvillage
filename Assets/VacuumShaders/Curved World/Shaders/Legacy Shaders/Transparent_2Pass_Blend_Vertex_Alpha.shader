...
Shader "Hidden/VacuumShaders/Curved World/Legacy Shaders/Transparent (2 Pass)/Vertex Alpha" 
{
	Properties 
	{
		...
		_VertexBlend("  Alpha Offset", Range(-1, 1)) = 0
		_BlendTex ("  Blend Map", 2D) = "gray" {}
		[CurvedWorldUVScroll] _V_CW_BlendTex_Scroll("    ", vector) = (0, 0, 0, 0)
	...
	{     
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="Legacy Shaders/Transparent (2 Pass)/Vertex Alpha" 
		...
		CGPROGRAM 
		#pragma surface surf BlinnPhong alpha:blend vertex:vert addshadow nodirlightmap nodynlightmap
		#pragma target 3.0 		   
