...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    private void Apply(Transform dummyTarget, Vector3 dummyCenter)
    {
        ...
        if (snap)
        {
            ...
            currentAngle = Mathf.SmoothDampAngle(currentAngle, targetAngle, ref angleVelocity, snapSmoothLag,
                snapMaxSpeed);
        }
        ...
        else
        {
            ...
            currentAngle = Mathf.SmoothDampAngle(currentAngle, targetAngle, ref angleVelocity, angularSmoothLag,
                angularMaxSpeed);
        }
